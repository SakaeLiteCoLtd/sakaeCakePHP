...
<table style="margin-bottom:0px" width="750" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
   <tr style="background-color: #E6FFFF">
     <td style="padding: 0.1rem 0.1rem; text-align: center"><?php echo $this->Html->image('Labelimg/accountMaterialKaikakeTouroku.gif');?></td>
   </tr>
 </table>
<br><br>
<?php if ($roleCheck == 1): ?>
...
<?php else : ?>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'materialkaikakeconfirm']]) ?>
  ...
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
      ...
      <tr style="border-bottom: 0px;border-width: 0px">
        ...
        <td width="280" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("element", ["type"=>"select","empty"=>"選択してください", "options"=>$arrAccountKaikakeElement, 'label'=>false]) ?></td>

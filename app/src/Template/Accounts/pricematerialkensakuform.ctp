...
<br><br>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'pricematerialkensakuichiran']]) ?>
    ...
    <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
      <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
        <tr>
          ...
          <td width="400" colspan="40" nowrap="nowrap"><div align="center"><strong style="font-size: 13pt; color:blue">受入日付</strong></div></td>
        </tr>

        <tr>
          <td rowspan='2' height='6' colspan='20' style='border-bottom: 1px solid black;border-width: 1px'><?= $this->Form->control('grade', array('type'=>'text', 'label'=>false)) ?></td>

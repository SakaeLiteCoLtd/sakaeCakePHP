...
<br><br>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'pricematerialmastersyuseido']]) ?>
  ...
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <br>
  <tr bgcolor="#E6FFFF" >
    <td align="center" rowspan="2" width="30" bgcolor="#E6FFFF" style="border: none"><div align="center"><?= $this->Form->submit(__('更新'), array('name' => 'do')); ?></div></td>
  </tr>
  </table>

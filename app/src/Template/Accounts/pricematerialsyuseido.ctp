...
<br><br>
  ...
  <?= $this->Form->create($OrderMaterials, ['url' => ['action' => 'menu']]) ?>
  ...
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
      <tr style="border-bottom: 0px;border-width: 0px">
        <td width="180" nowrap="nowrap"><div align="center"><strong style="font-size: 13pt; color:blue">オーダーID</strong></div></td>
        ...
        <td width="180" nowrap="nowrap"><div align="center"><strong style="font-size: 13pt; color:blue">数量</strong></div></td>

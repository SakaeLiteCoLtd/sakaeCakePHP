...
<br><br>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'ukeirekensakuichiran']]) ?>
  ...
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
      ...
      <tr>
        <td  rowspan='2'  height='6' colspan='20' style='border-bottom: 1px solid black;border-width: 1px'><?= $this->Form->input("customer_code", ["type"=>"select","empty"=>"選択してください", "options"=>$arrCustomer, 'label'=>false]) ?></td>

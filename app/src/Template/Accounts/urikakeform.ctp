...
<?php else : ?>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'urikakeconfirm']]) ?>
  ...
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
      ...
      <tr style="border-bottom: 0px;border-width: 0px">
        <td width="280" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("customer", ["type"=>"select","empty"=>"選択してください", "options"=>$arrCustomer, 'label'=>false]) ?></td>
        <td width="280" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("urikakeelement", ["type"=>"select","empty"=>"選択してください", "options"=>$arrAccountUrikakeElement, 'label'=>false]) ?></td>
        ...
        <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('price', array('type'=>'text', 'label'=>false)) ?></td>
      </tr>

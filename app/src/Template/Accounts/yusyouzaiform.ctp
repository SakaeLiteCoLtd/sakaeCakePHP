...
<br><br>
  ...
  <?= $this->Form->create($user, ['url' => ['action' => 'yusyouzaiconfirm']]) ?>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("customer", ["type"=>"select","empty"=>"選択してください", "options"=>$arrCustomer, 'label'=>false]) ?></td>
	</tr>
</table>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  <tr>
  ...
  <tr>
    ...
    <td width="280"  bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("flag_product_material", ["type"=>"select","empty"=>"選択してください", "options"=>$arrType, 'label'=>false]) ?></td>
	</tr>
</table>

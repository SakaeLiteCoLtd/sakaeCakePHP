...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($user, ['url' => ['action' => 'roleeditdo']]) ?>
    <fieldset>
      <br>
      <div align="center"><font color="black" size="3"><?= __("下のように更新します。よろしければ決定ボタンを押してください。") ?></font></div>
      <br>
...
<?= $this->Form->control('role_id', array('type'=>'hidden', 'value'=>$role_id, 'label'=>false)) ?>

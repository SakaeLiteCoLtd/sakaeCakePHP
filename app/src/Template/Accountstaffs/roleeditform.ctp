...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($user, ['url' => ['action' => 'roleeditconfirm']]) ?>
    <fieldset>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td width="280" bgcolor="#FFFFCC" style="font-size: 11pt;padding: 0.2rem"><?= $this->Form->input("role_id", ["type"=>"select","empty"=>"選択してください", "options"=>$arrRole, 'label'=>false]); ?></td>
	</tr>
</table>
<br>
    </fieldset>

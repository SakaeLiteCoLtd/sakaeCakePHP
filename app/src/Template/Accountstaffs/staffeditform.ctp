...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($user, ['url' => ['action' => 'staffeditconfirm']]) ?>
    <fieldset>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('f_name', array('type'=>'text', 'value'=>$f_name, 'label'=>false, 'autofocus'=>true, 'required'=>true)) ?></td>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('l_name', array('type'=>'text', 'value'=>$l_name, 'label'=>false, 'required'=>true)) ?></td>
	</tr>
</table>
<br>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('staff_code', array('type'=>'text', 'value'=>$staff_code, 'pattern'=>'^[0-9.-]+$', 'title'=>'半角数字で入力して下さい。', 'label'=>false, 'required'=>true)) ?></td>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('tel', array('type'=>'text', 'value'=>$tel, 'pattern'=>'^[0-9.-]+$', 'title'=>'半角数字で入力して下さい。', 'label'=>false)) ?></td>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("birth", array('type' => 'date', 'value'=>$birth, 'monthNames' => false, 'minYear' => date('Y') - 70, 'label'=>false, 'empty'=>true)); ?></td>
	</tr>
</table>
<br>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("date_start", array('type' => 'date', 'value'=>$date_start, 'monthNames' => false, 'minYear' => date('Y') - 70, 'label'=>false, 'empty'=>true)); ?></td>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('address', array('type'=>'text', 'value'=>$address, 'label'=>false)) ?></td>
	</tr>
</table>
<br>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("date_finish", array('type' => 'date', 'monthNames' => false, 'minYear' => date('Y') - 70, 'label'=>false, 'empty'=>true)); ?></td>
	</tr>
</table>

...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($user, ['url' => ['action' => 'staffeditform']]) ?>
    <fieldset>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($sex) ?></td>
	</tr>
</table>
<br>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
...
<br><br>
    ...
    <tr>
      <td style="border-style: none;"><div align="center"><?= $this->Form->submit(__('編集・削除'), array('name' => 'kakunin')); ?></div></td>
    </tr>
  </table>
<br>

...
<?=$this->Form->create($Materials, ['url' => ['action' => 'editdo']]) ?>
<br>
<div align="center"><font color="black" size="3"><?= __("以下ように登録します。よろしければ決定ボタンを押してください") ?></font></div>
<br>
...
<table align="center">
  <tr bgcolor="#E6FFFF" >
    ...
    <td bgcolor="#E6FFFF" style="border: none"><?= $this->Form->submit(__('決定'), array('name' => 'kensaku')); ?></td>
  </tr>
</table>
</fieldset>
<br><br>
...
<?= $this->Form->control('name_substitute', array('type'=>'hidden', 'value'=>$name_substitute, 'label'=>false)) ?>

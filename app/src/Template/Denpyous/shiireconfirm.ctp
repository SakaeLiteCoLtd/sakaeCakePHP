 ...
 <br><br><br>
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
        ...
        <tr style="border-bottom: solid;border-width: 1px">
          ...
          <td bgcolor="#FFFFCC"><?= $this->Form->input('syoumousupplierid', ["type"=>"select", "empty"=>"選択してください", "options"=>$arrElement, 'label'=>false, 'required'=>true]); ?></td>
        </tr>
      </table>
      <br><br><br><br>
      <br><br><br><br>
      ...
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
        <tr style="border-bottom: solid;border-width: 1px">
          <td width='150'  bgcolor="#FFFFCC"><strong style="font-size: 10pt; color:blue">品番、または品名、発注名</strong></td>

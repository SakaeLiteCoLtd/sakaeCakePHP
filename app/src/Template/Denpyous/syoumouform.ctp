...
?>
        ...
        <?= $this->Flash->render() ?>
        <?= $this->Form->create($Users, ['url' => ['action' => 'syoumouformtuika']]) ?>
 <br><br><br>
      ...
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
        ...
        <tr style="border-bottom: solid;border-width: 1px">
          <td bgcolor="#FFFFCC"><?= $this->Form->input('fromorderid', ["type"=>"select", "empty"=>"選択してください", "options"=>$arrHatyubusyo, 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('num_order', ["type"=>"text", 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('syoumousupplierid', ["type"=>"select", "empty"=>"選択してください", "options"=>$arrSyoumouSupplier, 'label'=>false, 'required'=>true]); ?></td>
        </tr>
      ...
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
        <tr>
          ...
          <td  width="150" bgcolor="#FFFFCC" style="font-size: 12pt;"><strong style="font-size: 10pt"><?= __("￥ － 　") ?></strong></td>
      	</tr>
      </table>
...
<legend align="left"><strong style="font-size: 11pt; color:red"><?= __("納入日が不明な場合は、おおよその日付で入力してください。") ?></strong></legend>
      ...
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
        <tr bgcolor="#E6FFFF" >
          <td width="600" colspan="40" nowrap="nowrap" bgcolor="#E6FFFF" style="border: none"><div align="center"><strong style="font-size: 15pt; color:blue"></strong></div></td>
          <td width="400" colspan="50" nowrap="nowrap" bgcolor="#E6FFFF" style="border: none"><div align="center"><strong style="font-size: 15pt; color:blue"></strong></div></td>
      ...
      <table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
        <tr style="border-bottom: solid;border-width: 1px">
          ...
          <td bgcolor="#FFFFCC"><strong style="font-size: 10pt; color:blue">仕入項目</strong></td>
          <td bgcolor="#FFFFCC"><strong style="font-size: 10pt; color:blue">品番、機械番号etc</strong></td>
        ...
        <tr style="border-bottom: solid;border-width: 1px">
          ...
          <td bgcolor="#FFFFCC"><?= $this->Form->input('elementsiwakeid'.$i, ["type"=>"select", "empty"=>"選択してください", "options"=>$arrAccountSyoumouElement, 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('order_product_code'.$i, ["type"=>"text", 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('order_product_name'.$i, ["type"=>"text", 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('price'.$i, ["type"=>"text", 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><?= $this->Form->input('amount'.$i, ["type"=>"text", 'label'=>false, 'required'=>true]); ?></td>
          <td bgcolor="#FFFFCC"><div align="center"><?= $this->Form->input("date_deliver".$i, array('type' => 'date', 'monthNames' => false, 'label'=>false)); ?></div></td>
        </tr>

...
<hr size="5" style="margin: 0.5rem">
<?= $this->Form->create($stockEndMaterials, ['url' => ['action' => 'editformsyousai']]) ?>
<br>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem">
      <?= $this->Form->control('materialgrade_color', array('type'=>'text', 'label'=>false, 'id'=>"material_list", 'required'=>true, 'autofocus'=>true)) ?>
    </td>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem">
      <?= $this->Form->control('lot_num', array('type'=>'text', 'label'=>false, 'required'=>true)) ?>
    </td>
	</tr>
</table>
<br>

...
<?php
 ...
 <hr size="5" style="margin: 0.5rem">
	...
	<?php
  echo $this->Form->create($KouteiKensahyouHeads, ['url' => ['action' => 'editconfirm']]);
  $options2 = [
    '0' => '新バージョン登録',
    '1' => '登録内容修正　　'
  ];
...
<?php
echo $this->Form->hidden('id' ,['value'=>$KouteiKensahyouHeads->id]);
echo $this->Form->hidden('version' ,['value'=>$KouteiKensahyouHeads->version+1]);

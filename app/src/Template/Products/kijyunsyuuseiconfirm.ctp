...
?>
        <?php
          ...
          header('Pragma:');
          echo $this->Form->create($ZensuProducts, ['url' => ['action' => 'kijyunsyuuseido']]);
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
      ...
      <tr style="border-bottom: 0px;border-width: 0px">
        <td width="140" bgcolor="#FFFFCC" style="text-align: right;border-right-style: none"><?= h($this->request->getData('kijyun')) ?></td>
  ...
  echo $this->Form->hidden('ZensuProductId' ,['value'=>$this->request->getData('ZensuProductId')]);
  ?>

...
?>
        <?php
          ...
          header('Pragma:');
          echo $this->Form->create($Konpous, ['url' => ['action' => 'form']]);
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
    ...
    <tr style="border-bottom: 0px;border-width: 0px">
      <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($data['konpoudata']['product_code']) ?></td>
    </tr>
  </table>
  <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
    ...
    <tr>
      <td  width="140" bgcolor="#FFFFCC" style="text-align: right;border-right-style: none;padding: 0.2rem"><?= h($data['konpoudata']['irisu']) ?></td>

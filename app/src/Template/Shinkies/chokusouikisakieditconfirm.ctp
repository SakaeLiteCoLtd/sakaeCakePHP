...
?>
        <?php
          ...
          header('Pragma:');
          echo $this->Form->create($user, ['url' => ['action' => 'chokusouikisakieditdo']]);
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
        ...
        <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
          ...
          <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
            <td colspan="2"><div align="center"><strong style="font-size: 12pt; color:blue">使用・不使用</strong></div></td>
          <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
            <td colspan="2" bgcolor="#FFFFCC"><?= h($status_hyouji) ?></td>
</table>
...
<?= $this->Form->control('status', array('type'=>'hidden', 'value'=>$this->request->getData('status'), 'label'=>false)) ?>

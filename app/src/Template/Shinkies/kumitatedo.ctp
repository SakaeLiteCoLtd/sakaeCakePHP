...
?>
        <?php
          ...
          header('Pragma:');
          echo $this->Form->create($assembleProducts, ['url' => ['action' => 'kumitateproductform']]);
...
<table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
<tr bgcolor="#E6FFFF" >
<td align="left" rowspan="2" width="50" bgcolor="#E6FFFF" style="border: none"><div align="right"><?= $this->Form->submit(__('入力画面へ'), array('name' => 'kakunin')); ?></div></td>

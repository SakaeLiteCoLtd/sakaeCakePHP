...
?>
        <?php
          ...
          header('Pragma:');
          echo $this->Form->create($assembleProducts, ['url' => ['action' => 'kumitateformtuika']]);
...
<tr style="border-bottom: solid;border-width: 1px">
  ...
  <td bgcolor="#FFFFCC"><?= $this->Form->input('product'.$i, ["type"=>"text", 'label'=>false]); ?></td>
  <td bgcolor="#FFFFCC"><?= $this->Form->input('inzu'.$i, ["type"=>"text", 'label'=>false]); ?></td>
</tr>

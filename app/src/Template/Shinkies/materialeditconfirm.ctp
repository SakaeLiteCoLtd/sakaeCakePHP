...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($priceMaterials, ['url' => ['action' => 'materialeditdo']]) ?>
    <fieldset>
...
<?= $this->Form->control('sup_id', array('type'=>'hidden', 'value'=>$sup_id, 'label'=>false)) ?>
<?= $this->Form->control('sup_name', array('type'=>'hidden', 'value'=>$sup_name, 'label'=>false)) ?>

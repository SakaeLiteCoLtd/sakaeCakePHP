...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($priceMaterials, ['url' => ['action' => 'materialeditconfirm']]) ?>
    <fieldset>
      ...
      <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
        ...
        <tr>
          <td width="220" bgcolor="#FFFFCC" style="border-right-style: none;padding: 0.2rem"><?= $this->Form->control('price', array('type'=>'text', 'pattern'=>'^[0-9.-]+$', 'title'=>'半角数字で入力して下さい。', 'value'=>$price, 'label'=>false, 'autofocus'=>true, 'required'=>true)) ?></td>
          ...
          <td width="280"  bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input("sup_id", ["type"=>"select","empty"=>"選択してください", "options"=>$arrSupplier, 'value'=>$sup_id, 'label'=>false, 'required'=>true]) ?></td>
      	</tr>
      </table>
  <br>
      <table align="center">
...
<br>
<?= $this->Form->control('PriceMaterialId', array('type'=>'hidden', 'value'=>$PriceMaterialId, 'label'=>false)) ?>

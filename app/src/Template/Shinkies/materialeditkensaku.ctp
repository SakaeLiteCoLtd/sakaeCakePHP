...
<hr size="5" style="margin: 0.5rem">
    ...
    <?= $this->Form->create($priceMaterials, ['url' => ['action' => 'materialeditform']]) ?>
    <fieldset>

      <br>
      <div align="center"><font color="red" size="3"><?= __($mess) ?></font></div>
      <div align="center"><font color="black" size="3"><?= __("修正する原料のグレードと色を入力してください。") ?></font></div>
      <br>

<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  <tr>
    <td width="200" bgcolor="#FFFFCC" style="font-size: 8pt;padding: 0.2rem"><strong style="font-size: 11pt; color:blue">グレード_色</strong></td>
	</tr>
  <tr>
    <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->control('materialgrade_color', array('type'=>'text', 'label'=>false,'id'=>"material_list",  'autofocus'=>true, 'required'=>true)) ?></td>
	</tr>
</table>

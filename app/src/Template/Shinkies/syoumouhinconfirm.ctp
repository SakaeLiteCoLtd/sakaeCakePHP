...
?>
    ...
    <?= $this->Form->create($syoumouSuppliers, ['url' => ['action' => 'syoumouhindo']]) ?>
    <fieldset>
  ...
  <?= $this->Form->control('tax_include', array('type'=>'hidden', 'value'=>$this->request->getData('tax_include'), 'label'=>false)) ?>

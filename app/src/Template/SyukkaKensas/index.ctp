...
<table style="margin-bottom:0px" width="750" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
          <tr style="background-color: #E6FFFF">
            ...
            <td style="padding: 0.1rem 0.1rem;"><a href="qr/index.php"><?php echo $this->Html->image('ShinkiTourokuMenu/im_taiou_touroku.gif',array('width'=>'105','height'=>'36','url'=>array('controller'=>'SyukkaKensas','action'=>'index2')));?></td>

...
<table width="900"  align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  <tr>
    ...
    <td width="150" colspan="2" bgcolor="#FFFFCC" style="font-size: 12pt;border-right-style: none"><strong style="font-size: 11pt; color:blue">検索日時の種類</strong></td>
    <td bgcolor="#FFFFCC" style="border-left-style: none"><?= $this->Form->input('place_deliver', ["type"=>"select", "options"=>$arrKensakuday, 'label'=>false]); ?></td>
	</tr>
  <tr>
    ...
    <td bgcolor="#FFFFCC" style="border-left-style: none"><?= $this->Form->control('datefin', array('type'=>'datetime', 'monthNames' => false, 'value' => $dateTomo, 'label'=>false)) ?></td>
	</tr>
</table>
<br><br>
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0" style="border-bottom: solid;border-width: 1px">
  ...
  <tr>
    <td  width="200" bgcolor="#FFFFCC"><?= $this->Form->input('ContRejection', ["type"=>"select", "options"=>$arrContRejection, 'label'=>false, 'allowempty'=>true]); ?></td>
    <td width="170"  bgcolor="#FFFFCC" style="border-right-style: none"><?= $this->Form->control('amount', array('type'=>'text', 'label'=>false)) ?></td>
    <td width="80"  bgcolor="#FFFFCC" style="border-left-style: none"><strong style="font-size: 8pt; color:blue">ヶ以上</strong></td>

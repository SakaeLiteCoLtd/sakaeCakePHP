...
<?php
 ...
 <table style="margin-bottom:0px" width="600" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
 <?php
    echo $htmlLabels;
 ?>
 </table>
...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  ...
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
    <tr style="border-bottom: 0px;border-width: 0px">
      <td width="5" colspan="10" nowrap="nowrap"><div align="center"></div></td>
      <td width="150" height="30" colspan="20" nowrap="nowrap"><div align="center"><strong style="font-size: 13pt; color:blue">品番</strong></div></td>
      <td width="200" colspan="30" nowrap="nowrap"><div align="center"><strong style="font-size: 13pt; color:blue">成形時間</strong></div></td>
      <td width="100" colspan="20" nowrap="nowrap"><div align="center"><strong style="font-size: 10pt; color:blue">予定枚数</strong></div></td>
      <td width="100" colspan="20" nowrap="nowrap"><div align="center"><strong style="font-size: 10pt; color:blue">箱NO.</strong></div></td>
    </tr>
 ...
 && null == ($this->request->getData("7gouki")) && null == ($this->request->getData("8gouki")) && null == ($this->request->getData("9gouki"))) {//1gouki以外のやつが押されたら消えるようにする
   for($i=1; $i<=${"n".$j}; $i++){//１号機
    ...
    ${"present_kensahyou".$i} = ${"arrP".$j.$i}['present_kensahyou'];
        ...
        echo "開始";
        echo "</strong></div></td>\n";
        echo "<td colspan='27' nowrap='nowrap' style='border-bottom: 0px'><div align='center'>\n";
        ...
        echo "終了";
        echo "</strong></div></td>\n";
        echo "<td colspan='27'><div align='center'>\n";

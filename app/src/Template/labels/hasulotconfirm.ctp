 ...
 <br><br><br>
    <?= $this->Flash->render() ?>
    <?= $this->Form->create($MotoLots, ['url' => ['action' => 'hasulotdo']]) ?>
    <br><br><br><br>

    <?php if(($amount_sum == $amount) && ($check_product != 1))://問題なしの時 ?>
...
<table align="left" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
<tr bgcolor="#E6FFFF" >
  <td align="left" rowspan="2" width="50" bgcolor="#E6FFFF" style="border: none"><div align="left"><?= $this->Form->submit(__('登録'), array('name' => 'kakunin')); ?></div></td>
...
<br><br><br>
  ...
  <?php elseif($amount_sum == $amount): //製品が違う時 ?>
    <br><br>
    <legend align="center"><font color="red"><?= __('＊そのロットは、製品が違います。') ?></font></legend>
    <br><br><br><br><br>
  <?php else: //合計数量が違う時 ?>
    <br><br>
    <legend align="center"><font color="red"><?= __('＊端数ロットの数量と元ロットの数量の合計が合いません。') ?></font></legend>
    <br><br><br><br><br>
  <?php endif; ?>

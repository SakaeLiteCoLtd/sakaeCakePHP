...
<form action="kakunin_touroku_place.php" method="post">
  ...
  <table width="750" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="place1" value="{$place1}" size="100"/></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">納品場所２</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="place2" value="{$place2}" size="100"/></div></td>
    </tr>
  </table>

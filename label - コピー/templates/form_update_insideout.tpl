...
<br>
<br>
<form action="rs_update_insideout.php" method="post">
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$product_id}</strong><input type="hidden" name="product_id" value="{$product_id}" size="30"/></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">袋数</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="num_inside" value="{$num_inside}" size="15"/><strong>袋</strong></div></td>
    </tr>
  </table>

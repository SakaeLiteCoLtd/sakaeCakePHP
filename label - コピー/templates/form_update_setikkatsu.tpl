...
<form action="rs_update_setikkatsu.php" method="post">
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$product_id1}</strong><input type="hidden" name="product_id1" value="{$product_id1}" size="30"/></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">品番2</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="product_id2" value="{$product_id2}" size="30"/></div></td>
    </tr>
  </table>

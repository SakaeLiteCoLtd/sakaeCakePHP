...
<table width="800" border="0">
  ...
  <hr>
<form action="rs_touroku_layout.php" method="post">
  ...
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$product}</strong><input type="hidden" name="product" value="{$product}" /></div></td>
    </tr>
    {$html_product2}
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">納入先</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$name_place}</strong><input type="hidden" name="place_id" value="{$place_id}" /></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">梱包単位</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$unit}</strong><input type="hidden" name="unit_id" value="{$unit_id}" /></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">ラベルタイプ</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$type_label}</strong><input type="hidden" name="type_label" value="{$type_label}" /></div></td>
    </tr>
  </table>

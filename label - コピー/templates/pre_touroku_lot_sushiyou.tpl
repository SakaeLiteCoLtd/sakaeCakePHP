...
<form action="kakunin_touroku_lot_fushiyou.php" method="post">
  ...
  <table width="500" border="0" align="center" bgcolor="#666666">
    ...
    <tr>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$fushiyou_product_id}</strong><input type="hidden" name="product_id" value="{$fushiyou_product_id}" size="30"/></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$fushiyou_lot_num}</strong><input type="hidden" name="lot_num" value="{$fushiyou_lot_num}" size="30"/></div></td>

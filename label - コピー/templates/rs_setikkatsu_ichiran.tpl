...
{foreach from=$ichiran item=id}
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$id.product_id1}</strong><input type="hidden" name="product_id1[]" value="{$id.product_id1}" size="30"/></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$id.product_id2}</strong><input type="hidden" name="product_id2[]" value="{$id.product_id2}" size="30"/></div></td>
    </tr>
{/foreach}
  </table>
<br>

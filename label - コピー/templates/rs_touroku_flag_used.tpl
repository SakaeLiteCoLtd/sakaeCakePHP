...
<form action="rs_touroku_insideout.php" method="post">
  ...
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$id}</strong><input type="hidden" name="id" value="{$id}" /></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">袋数</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$name}</strong><input type="hidden" name="name" value="{$name}" /><strong>袋</strong></div></td>
    </tr>
  </table>

...
<form action="rs_touroku_insideout.php" method="post">
  ...
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$rs_product_id1}</strong><input type="hidden" name="product_id1" value="{$rs_product_id1}" /></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">品番2</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong>{$rs_product_id2}</strong><input type="hidden" name="product_id2" value="{$rs_product_id2}" /></div></td>
    </tr>
  </table>

<?php /* Smarty version 2.6.26, created on 2013-09-11 16:14:41
         compiled from kakunin_touroku_layout.tpl */ ?>
...
" /></div></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['name_place']; ?>
</strong><input type="hidden" name="place_id" value="<?php echo $this->_tpl_vars['place_id']; ?>
" /></div></td>
    </tr>
    <tr>
...
</strong><input type="hidden" name="unit_id" value="<?php echo $this->_tpl_vars['unit_id']; ?>
" /></div></td>
    </tr>
    <tr>

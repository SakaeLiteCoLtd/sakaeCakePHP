<?php /* Smarty version 2.6.26, created on 2013-09-07 15:30:25
         compiled from form_touroku_unit.tpl */ ?>
...
<table width="800" border="0">
  ...
  <hr>
<form action="kakunin_touroku_unit.php" method="post">
  <p align="center" ><strong><font color="#0000FF">ラベル梱包単位登録</font></strong></p>
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">単位</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="unit" value="<?php echo $this->_tpl_vars['unit']; ?>
" size="25"/></div></td>
    </tr>
  </table>
...
<p align="center">
<label>
<input type="submit" name="button" id="button" value="登録確認" />
</label>
</p>
<br>
</form>

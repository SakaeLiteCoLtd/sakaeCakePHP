<?php /* Smarty version 2.6.26, created on 2013-11-27 15:27:06
         compiled from pre_touroku_lot_sushiyou.tpl */ ?>
...
<form action="kakunin_touroku_lot_fushiyou.php" method="post">
  ...
  <table width="500" border="0" align="center" bgcolor="#666666">
    ...
    <tr>
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['fushiyou_product_id']; ?>
</strong><input type="hidden" name="product_id" value="<?php echo $this->_tpl_vars['fushiyou_product_id']; ?>
" size="30"/></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['fushiyou_lot_num']; ?>
</strong><input type="hidden" name="lot_num" value="<?php echo $this->_tpl_vars['fushiyou_lot_num']; ?>
" size="30"/></div></td>

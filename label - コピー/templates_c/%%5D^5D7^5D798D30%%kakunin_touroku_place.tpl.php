<?php /* Smarty version 2.6.26, created on 2013-10-31 14:57:10
         compiled from kakunin_touroku_place.tpl */ ?>
...
<form action="rs_touroku_place.php" method="post">
  ...
  <table width="750" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['place1']; ?>
</strong><input type="hidden" name="place1" value="<?php echo $this->_tpl_vars['place1']; ?>
" size="100"/></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">納品場所２</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['place2']; ?>
</strong><input type="hidden" name="place2" value="<?php echo $this->_tpl_vars['place2']; ?>
" size="100"/></div></td>
    </tr>
  </table>

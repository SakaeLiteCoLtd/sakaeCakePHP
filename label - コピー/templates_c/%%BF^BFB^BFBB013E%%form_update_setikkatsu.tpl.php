<?php /* Smarty version 2.6.26, created on 2013-10-09 10:22:23
         compiled from form_update_setikkatsu.tpl */ ?>
...
<br>
<br>
<form action="rs_update_setikkatsu.php" method="post">
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['product_id1']; ?>
</strong><input type="hidden" name="product_id1" value="<?php echo $this->_tpl_vars['product_id1']; ?>
" size="30"/></div></td>
    </tr>
    <tr>

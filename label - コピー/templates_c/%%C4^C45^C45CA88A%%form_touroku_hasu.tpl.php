<?php /* Smarty version 2.6.26, created on 2013-09-07 09:37:13
         compiled from form_touroku_hasu.tpl */ ?>
...
" name="hasu_product_id" value="<?php echo $this->_tpl_vars['hasu_product_id']; ?>
...
" name="hasu_lot_num" value="<?php echo $this->_tpl_vars['hasu_lot_num']; ?>
" size="30"/></div></td>
...
<br />
<br />
<?php echo $this->_tpl_vars['label_addition']; ?>

<?php echo $this->_tpl_vars['label_deletion']; ?>
...
<table width="350" border="0" align="left" bordercolor="#666666" bgcolor="#666666">
  <tr>
    ...
    <td width="75" align="center" nowrap="nowrap" bgcolor="#FFFFCC"><strong><font color="#0000FF">元ロットNo.</font></strong></td>
...
?>
  <tr>
    <td height="17" align="center" bgcolor="#FFFFCC" nowrap="nowrap">
       <strong><?php echo $this->_tpl_vars['id']['radio']; ?>
</strong>
    </td>
    <td height="17" align="center" bgcolor="#FFFFCC" nowrap="nowrap">
       <strong><?php echo $this->_tpl_vars['id']['hyouji_moto_lot_num']; ?>
</strong>
       <input type="hidden" name="arr_check_lots_id[]" value="<?php echo $this->_tpl_vars['id']['arr_check_lots_id']; ?>
" /><input type="<?php echo $this->_tpl_vars['id']['type']; ?>
" name="moto_lot_num[]" value="<?php echo $this->_tpl_vars['id']['moto_lot_num']; ?>
" />
    </td>
    <td height="17" align="center" bgcolor="#FFFFCC" nowrap="nowrap">
       <strong><?php echo $this->_tpl_vars['id']['hyouji_moto_amount']; ?>
</strong>
       <input type="<?php echo $this->_tpl_vars['id']['type']; ?>
" name="moto_amount[]" value="<?php echo $this->_tpl_vars['id']['moto_amount']; ?>
" />
    </td>
  </tr>

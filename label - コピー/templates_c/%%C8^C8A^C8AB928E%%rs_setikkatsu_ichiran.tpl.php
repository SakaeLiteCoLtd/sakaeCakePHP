<?php /* Smarty version 2.6.26, created on 2013-12-11 18:38:51
         compiled from rs_setikkatsu_ichiran.tpl */ ?>
...
<br>
<br>
<form action="form_update_setikkatsu.php" method="post">
  <table width="550" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td width="120" bgcolor="#FFFFCC" ><div align="center" class="style1"><strong><font color="#0000FF">品番1</font></strong></div></td>
      <td width="120" bgcolor="#FFFFCC" ><div align="center" class="style1"><strong><font color="#0000FF">品番2</font></strong></div></td>
    </tr>
...
?>
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['id']['product_id1']; ?>
</strong><input type="hidden" name="product_id1[]" value="<?php echo $this->_tpl_vars['id']['product_id1']; ?>
" size="30"/></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['id']['product_id2']; ?>
</strong><input type="hidden" name="product_id2[]" value="<?php echo $this->_tpl_vars['id']['product_id2']; ?>
" size="30"/></div></td>
    </tr>

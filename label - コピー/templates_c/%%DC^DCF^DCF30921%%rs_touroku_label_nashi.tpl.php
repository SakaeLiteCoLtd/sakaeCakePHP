<?php /* Smarty version 2.6.26, created on 2013-12-11 18:19:36
         compiled from rs_touroku_label_nashi.tpl */ ?>
...
<table width="800" border="0">
  ...
  <hr>
<form action="rs_touroku_label_nashi.php" method="post">
  ...
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      ...
      <td bgcolor="#FFFFCC"><div align="center"><strong><?php echo $this->_tpl_vars['rs_product_id']; ?>
</strong><input type="hidden" name="product_id" value="<?php echo $this->_tpl_vars['rs_product_id']; ?>
" /></div></td>
    </tr>
  </table>

<?php /* Smarty version 2.6.7, created on 2013-09-09 13:41:09
         compiled from form_touroku_flag_used.tpl */ ?>
...
<br>
<br>
<form action="rs_touroku_flag_used.php" method="post">
  <table width="350" border="0" align="center" bgcolor="#666666">
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF">ID</font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="id" value="<?php echo $this->_tpl_vars['id']; ?>
" size="30"/></div></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFCC"><div align="center" class="style1"><strong><font color="#0000FF"></font></strong></div></td>
      <td bgcolor="#FFFFCC"><div align="center"><input type="text" name="name" value="" size="30"/><strong></strong></div></td>
    </tr>
  </table>
